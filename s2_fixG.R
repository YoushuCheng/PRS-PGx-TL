...
#     need columns: ID, Y, covars (including Tr), prs_g
#     
...
#953    100    100     3 0.0506121

#save the parameter 
write.table(best, paste0(s2_output, '_initial_',initial,'_best_R2.txt'), quote=F, row.names=F, col.names=T, sep='\t')
